...
This plugin provides the ability to submit ISRCs to the MusicBrainz server specified in the Option settings.
...
The source code for this plugin is available on `GitHub <https://github.com/rdswift/picard-plugin-submit-isrc>`_.
